...
if ( ! class_exists( 'Subscriptions_For_Woocommerce_Cancel_Subscription_Email' ) ) {
    ...
    class Subscriptions_For_Woocommerce_Cancel_Subscription_Email extends WC_Email {
        ...
        function __construct() {
            ...
            $this->description = __( 'This Email Notification Send if any susbcription is Cancelled', 'subscriptions-for-woocommerce' );

            $this->template_html  = 'mwb-sfw-cancel-subscription-email-template.php';
            $this->template_plain = 'plain/mwb-sfw-cancel-subscription-email-template.php';
         ...
         * @return void
         */
        function trigger( $mwb_subscription ) {
        ...
        function get_content_html() {
            return wc_get_template_html(
                ...
                array(
                    ...
                    'sent_to_admin'      => true,
                    'plain_text'         => false,
                    'email' => $this ), 'subscriptions-for-woocommerce', $this->template_base );
        }
