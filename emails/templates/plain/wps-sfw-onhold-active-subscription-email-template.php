...
<p><?php printf( esc_html__( 'A subscription [#%s] has been Activated From On-hold By Admin. Their subscription\'s details are as follows:', 'subscriptions-for-woocommerce' ), esc_html( $wps_subscription ) ); ?></p>
