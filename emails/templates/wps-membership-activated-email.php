<?php
/**
 * Membership Activated — HTML email template.
 *
 * Variables available:
...
<p><?php esc_html_e( 'Your membership has been activated. Here are the details:', 'subscriptions-for-woocommerce' ); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width:100%;border-collapse:collapse;" border="1">
	...
	<tr>
		...
		<td style="padding:8px;"><?php esc_html_e( 'Active', 'subscriptions-for-woocommerce' ); ?></td>
	</tr>
	<?php if ( $start_ts ) : ?>
	<tr>
		<th style="text-align:left;padding:8px;background:#f5f5f5;"><?php esc_html_e( 'Start Date', 'subscriptions-for-woocommerce' ); ?></th>
		<td style="padding:8px;"><?php echo esc_html( date_i18n( get_option( 'date_format' ), $start_ts ) ); ?></td>
	</tr>
	<?php endif; ?>
	<?php if ( $end_ts ) : ?>
	<tr>
		<th style="text-align:left;padding:8px;background:#f5f5f5;"><?php esc_html_e( 'Access Until', 'subscriptions-for-woocommerce' ); ?></th>
		<td style="padding:8px;"><?php echo esc_html( date_i18n( get_option( 'date_format' ), $end_ts ) ); ?></td>
	</tr>
	<?php endif; ?>
</table>

<?php do_action( 'wps_membership_activated_email_details', $membership_data, $email ); ?>
