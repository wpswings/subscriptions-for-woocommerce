<?php
/**
 * Membership Email — Activated (Day 10 stub)
 *
 ...
 * (new_status = active). Full implementation lands on Day 10 (June 17).
 *
 * @since      2.0.0
...
if ( ! class_exists( 'WPS_Membership_Activated_Email' ) ) {
	...
	class WPS_Membership_Activated_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->description    = __( 'Sent when a user\'s membership becomes active.', 'subscriptions-for-woocommerce' );
