...
class Subscriptions_For_Woocommerce_Public {
	...
	public function mwb_sfw_woocommerce_order_button_text( $text ){
		$mwb_sfw_get_add_to_cart_button_text = $this->mwb_sfw_get_add_to_cart_button_text();
		$this->mwb_sfw_check_cart_has_subscription_product();
		var_dump( $this->mwb_sfw_check_cart_has_subscription_product() );
		return $text;
	}
