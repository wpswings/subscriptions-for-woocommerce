...
class Subscriptions_For_Woocommerce {
	...
	private function subscriptions_for_woocommerce_public_hooks() {
		...
		$this->loader->add_filter('woocommerce_cart_product_price', $sfw_plugin_public, 'mwb_sfw_show_subscription_price_on_cart',10,2);

		$this->loader->add_filter('woocommerce_order_formatted_line_subtotal', $sfw_plugin_public, 'mwb_sfw_show_subscription_subtotal_on_cart',10,3);
						...
						<div class="mwb-form-group__control mwb-pl-4">
							<div class="mdc-form-field">
								<div class="mdc-checkbox">
									...
									value="<?php echo esc_attr( $sfw_component['value'] ); ?>"
									<?php if( 'on' === $sfw_component['checked'] ){
							...
							<div>
								<div class="mdc-switch">
									...
									<div class="mdc-switch__thumb-underlay">
										...
										<input name="<?php echo esc_html( $sfw_component['id'] ); ?>" type="checkbox" id="basic-switch" value="on" class="mdc-switch__native-control" role="switch" aria-checked="<?php if ( 'on' == $sfw_component['value'] ) echo 'true'; else echo 'false'; ?>"
