	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<p class="form-field mwb_sfw_subscription_price_field ">
			...
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_number" id="mwb_sfw_subscription_price" value="" placeholder="<?php esc_html_e('Enter subscription price','subscriptions-for-woocommerce');?>"> 
