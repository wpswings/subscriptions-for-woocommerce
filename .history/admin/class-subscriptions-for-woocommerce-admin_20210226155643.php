...
class Subscriptions_For_Woocommerce_Admin {
	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription( $post_id ){
		update_post_meta( $post_id,'mwb_sfw_subscription_number', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_interval', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_expiry_number', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_expiry_interval', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_initial_signup_price', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_free_trial_number', true );
		update_post_meta( $post_id,'mwb_sfw_subscription_free_trial_interval', true );
		?>
		...
		<p class="form-field mwb_sfw_subscription_number_field ">
			...
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_number" id="mwb_sfw_subscription_number" value="" placeholder="<?php esc_html_e('Enter subscription interval','subscriptions-for-woocommerce');?>"> 
			<select id="mwb_sfw_subscription_interval" name="mwb_sfw_subscription_interval" class="mwb_sfw_subscription_interval" >
				<?php foreach ( $this->mwb_sfw_subscription_period() as $value => $label ) { ?>
					<option value="<?php echo esc_attr( $value ); ?>" <?php selected( $value, '', true ) ?>><?php echo esc_html( $label ); ?></option>
				<?php } ?>
				</select>
		...
		<p class="form-field mwb_sfw_subscription_expiry_field ">
			...
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_expiry_number" id="mwb_sfw_subscription_expiry_number" value="" placeholder="<?php esc_html_e('Enter subscription expiry','subscriptions-for-woocommerce');?>"> 
		...
		<p class="form-field mwb_sfw_subscription_initial_signup_field ">
			...
			<input type="text" class="short wc_input_price"  name="mwb_sfw_subscription_initial_signup_price" id="mwb_sfw_subscription_initial_signup_price" value="" placeholder="<?php esc_html_e('Enter signup fee','subscriptions-for-woocommerce');?>"> 
		...
		<p class="form-field mwb_sfw_subscription_free_trial_field ">
			...
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_free_trial_number" id="mwb_sfw_subscription_free_trial_number" value="" placeholder="<?php esc_html_e('Enter free trial interval','subscriptions-for-woocommerce');?>"> 
