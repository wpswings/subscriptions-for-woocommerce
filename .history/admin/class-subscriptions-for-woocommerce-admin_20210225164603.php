	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<p class="form-field mwb_sfw_subscription_initial_signup_field ">
			...
			<input type="text" class="short wc_input_price"  name="mwb_sfw_subscription_expiry_number" id="mwb_sfw_subscription_expiry_number" value="" placeholder="<?php esc_html_e('Enter subscription expiry','subscriptions-for-woocommerce');?>"> 
