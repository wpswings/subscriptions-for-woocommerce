...
class Subscriptions_For_Woocommerce_Admin {
	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<input type="text" class="short wc_input_price"  name="mwb_sfw_subscription_price" id="mwb_sfw_subscription_price" value="" placeholder="<?php esc_html_e('Enter price','subscriptions-for-woocommerce');?>"> 
