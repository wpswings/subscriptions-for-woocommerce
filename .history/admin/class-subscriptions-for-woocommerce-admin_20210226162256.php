	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<p class="form-field mwb_sfw_subscription_expiry_field ">
			...
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_expiry_number" id="mwb_sfw_subscription_expiry_number" value="<?php echo esc_attr( $value ); ?>" placeholder="<?php esc_html_e('Enter subscription expiry','subscriptions-for-woocommerce');?>"> 
