	...
	*/
	...
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<p class="form-field mwb_sfw_subscription_price_field ">
			...
			<?php esc_html_e('Subscriptions Interval','subscriptions-for-woocommerce');?>
			</label>
			<input type="number" class="short wc_input_number"  name="mwb_sfw_subscription_number" id="mwb_sfw_subscription_number" value="" placeholder="<?php esc_html_e('Enter subscription price','subscriptions-for-woocommerce');?>"> 
