...
class Subscriptions_For_Woocommerce_Admin {
	...
	public function mwb_sfw_save_custom_product_fields_data_for_subscription( $post_id, $post ) {
		var_dump( wp_verify_nonce( $_POST['mwb_sfw_edit_nonce_filed'], 'mwb_sfw_edit_nonce' ) );
		if ( isset $_POST['mwb_sfw_edit_nonce_filed'] ) || ! wp_verify_nonce( wp_unslash( $_POST['mwb_sfw_edit_nonce_filed'] ), 'mwb_sfw_edit_nonce' ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			return;
		}
