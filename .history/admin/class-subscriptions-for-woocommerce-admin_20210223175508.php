...
class Subscriptions_For_Woocommerce_Admin {
	...
	public function sfw_admin_general_settings_page( $sfw_settings_general ) {
		...
		$sfw_settings_general = array(
			array(
				'title' => __( 'Enable plugin', 'subscriptions-for-woocommerce' ),
				'type'  => 'radio-switch',
				'description'  => __( 'Enable plugin to start the functionality.', 'subscriptions-for-woocommerce' ),
				'id'    => 'mwb_subscription_enable_plugin',
				'value' => get_option( 'mwb_subscription_enable_plugin' ),
	...
	*/
	public function sfw_admin_save_tab_settings() {
		...
		if ( isset( $_POST['sfw_button_demo'] ) ) {
