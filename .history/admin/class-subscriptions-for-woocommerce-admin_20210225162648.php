	...
	*/
	...
	public function mwb_sfw_subscription_period( ) {
		$subscription_interval = array(
			'mwb_wgm_default_price' => __( 'Default Price', 'woo-gift-cards-lite' ),
			'mwb_wgm_range_price' => __( 'Price Range', 'woo-gift-cards-lite' ),
			'mwb_wgm_selected_price' => __( 'Selected Price', 'woo-gift-cards-lite' ),
			'mwb_wgm_user_price' => __( 'User Price', 'woo-gift-cards-lite' ),
		);
		return apply_filters( 'mwb_sfw_subscription_interval', $subscription_interval );
	}
	public function mwb_sfw_custom_product_fields_for_subscription(){
		...
		<p class="form-field mwb_sfw_subscription_price_field ">
			<label for="mwb_sfw_subscription_price">
			<?php esc_html_e('Subscriptions Price','subscriptions-for-woocommerce'); echo esc_html( '('.get_woocommerce_currency_symbol() .')' );?>
			</label>
			<input type="text" class="short wc_input_price"  name="mwb_sfw_subscription_price" id="mwb_sfw_subscription_price" value="" placeholder="<?php esc_html_e('Enter subscription price','subscriptions-for-woocommerce');?>"> 
