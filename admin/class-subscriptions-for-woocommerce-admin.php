...
class Subscriptions_For_Woocommerce_Admin {
	...
	public static function subscriptions_for_woocommerce_upgrade_wp_postmeta() {
		$wps_upgrade_sfw_wp_postmeta_check = get_option( 'wps_upgrade_sfw_wp_postmeta_check', 'not_done' );
		if ( 'not_done' === $wps_upgrade_sfw_wp_postmeta_check ) {
			...
			update_option( 'wps_upgrade_sfw_wp_postmeta_check', 'done' );
		}
	}
	/**
	 * Short Description. (use period)
	...
	public static function subscriptions_for_woocommerce_upgrade_wp_options() {
		$wps_upgrade_sfw_wp_option_check = get_option( 'wps_upgrade_sfw_wp_option_check', 'not_done' );
		if ( 'not_done' === $wps_upgrade_sfw_wp_option_check ) {
			...
			update_option( 'wps_upgrade_sfw_wp_option_check', 'done' );
