...
/**
 * Test case for membership core functions.
 *
 * @since   2.0.0
 * @package Subscriptions_For_Woocommerce
 */
class CoreFunctionsTest extends WP_UnitTestCase {
	...
	/**
	 * Test that seeding the schema version creates the option on first load.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that seeding the schema version does not overwrite an existing value.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that rebuilding the product-plan map returns an empty array when no plans exist.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that rebuilding the product-plan map correctly maps products to slugs.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that rebuilding the product-plan map persists the result to options.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that the last plan wins when two plans share a product ID.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that getting the product-plan map falls back to a rebuild when the option is missing.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that getting the product-plan map returns the cached option without triggering a rebuild.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that generating a unique plan slug sanitizes the input name.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that generating a unique plan slug appends a numeric suffix on collision.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that generating a unique plan slug increments the suffix until it is unique.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that generating a unique plan slug excludes the given plan from the collision check.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that generating a unique plan slug falls back to "plan" prefix when the name is empty.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that checking for a plan slug returns false when no plans exist.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that checking for a plan slug returns true for an existing slug.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that checking for a plan slug returns false when only the excluded plan matches.
	 *
	 * @return void
	 */
	...
	/**
	 * Test that checking for a plan slug returns false for an empty slug.
	 *
	 * @return void
	 */
