...
/**
 * Test case for plan purchase CTA product resolution.
 */
class PlanPurchaseCtaTest extends WP_UnitTestCase {
	 ...
	 * @param string $grant_method Grant method (purchase|subscription|auto_enroll).
	 * @param array  $product_ids  Array of product IDs to link.
	 * @return int Plan ID.
	 */
	...
	/**
	 * Subscription plan surfaces its subscription products.
	 *
	 * @return void
	 */
	...
	/**
	 * Purchase plan surfaces one-time purchase products.
	 *
	 * @return void
	 */
	...
	/**
	 * Auto-enroll plan has no purchasable products.
	 *
	 * @return void
	 */
	...
	/**
	 * Unpublished (draft) products are excluded from purchasable list.
	 *
	 * @return void
	 */
	...
	/**
	 * CTA renders the product name for a subscription plan.
	 *
	 * @return void
	 */
	...
	/**
	 * CTA renders products from multiple plans across different grant methods.
	 *
	 * @return void
	 */
