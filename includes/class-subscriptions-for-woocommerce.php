...
class Subscriptions_For_Woocommerce {
	...
	public function mwb_sfw_plug_default_tabs() {
		...
		$sfw_default_tabs['subscriptions-for-woocommerce-template'] = array(
			'title'       => esc_html__( 'Templates', 'subscriptions-for-woocommerce' ),
			'name'        => 'subscriptions-for-woocommerce-template',
		);
						...
						<div class="mwb-form-group__control mwb-pl-4">
							<div class="mdc-form-field">
								<div class="mdc-checkbox">
									...
									value="<?php echo esc_attr( $sfw_component['value'] ); ?>"
									<?php checked( $sfw_component['value'], '1' ); ?>
									/>
								...
								<label for="checkbox-1"><?php echo esc_html( $sfw_component['description'] ); // WPCS: XSS ok. ?></label>
							</div>
						</div>
					</div>
					<?php
